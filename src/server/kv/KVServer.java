...
public class KVServer {
        ...
        try {
            ...
            if ("GET".equals(h.getRequestMethod())) {
                ...
                if (value == null || value.isEmpty()) {
                    System.out.println("Value для загрузки пустой. value указывается в теле ответа");
                    h.sendResponseHeaders(400, 0);
                    return;
                }
    ...
    protected void sendResponse(HttpExchange exchange, String responseBody, int rCode) throws IOException {
